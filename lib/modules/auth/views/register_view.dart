...
class RegisterView extends StatelessWidget {
  ...
  Widget _buildRoleOptions(RegisterController logic) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      mainAxisAlignment: MainAxisAlignment.spaceAround,
      children: [
        Text(
          StringValues.selectRole,
        ...
        Wrap(
          ...
          children: logic.roleOptions
              .map(
                (role) => ElevatedButton(
                  onPressed: () => logic.selectRole(role),
                  child: Text(role),
                ),
              )
              .toList(),
        ),
        if (logic.selectedRole.isNotEmpty)
          Container(
            ...
            child: Text(
              '${StringValues.userWarning}: You picked ${logic.selectedRole}',
              style: AppStyles.style18Normal.copyWith(color: Colors.black),
            ),
          ),
      ],
    );
